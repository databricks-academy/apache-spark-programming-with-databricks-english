...
display(train_df.select('price','bedrooms','bathrooms','bathrooms_na', 'minimum_nights', 'number_of_reviews'))

# COMMAND ----------

display(train_df.select('price','bedrooms','bathrooms','bathrooms_na', 'minimum_nights', 'number_of_reviews').summary())
...
vec_train_df.select(['bedrooms','bathrooms','bathrooms_na', 'minimum_nights', 'number_of_reviews']).show()
